...
********** Não tinha entendido o enunciado corretamente terminei criando um projeto spring do zero, quando fui c ommitar que vi que a estrutura do projeto ja estava pronta, infelizmente não da mais tempo, mas se puder avaliar  mesmo assim, ele esta localiado na pasta "fila" na raiz, obrigado!***********
